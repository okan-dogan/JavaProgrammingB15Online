...
public class CarInventory {
    ...
    public static void main(String[] args) {
        ...
        int countCivic=0, countChev=0;

        for (String eachCar : cars) {
            if(eachCar.toUpperCase().contains("CHEVROLET")){
                countChev++;
            }if(eachCar.toUpperCase().contains("CIVIC")){
                countCivic++;
            }
        }
        System.out.println(countChev+" Chevrolet(s) in the inventory\n"
                          +countCivic+" Civic(s) in the inventory");

        System.out.println();
        System.out.println("============   ONLY HONDAS  =================");

        for (String eachCar : cars) {
            if(eachCar.startsWith("Honda")){
                String[] hondaSplit=eachCar.split("-");
                System.out.println("Car make is "+hondaSplit[0]+" Car Model is "+hondaSplit[1]);
            }

        }

        System.out.println();
        System.out.println("============   CAR MODELS HAVING TWO CHARACTER  =================");
        for (int i = 0; i < cars.length; i++) {
            if (cars[i].substring(cars[i].indexOf("-") + 1).length() == 2) {
