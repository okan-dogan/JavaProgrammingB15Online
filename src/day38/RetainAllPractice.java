...
in the specified collection. In other words,
...
public class RetainAllPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("nums1 after nums1.retainAll(nums2)= " + nums1);

        nums2.retainAll(nums1);
        System.out.println("nums2 after nums2.retainAll(nums1)= " + nums2);
