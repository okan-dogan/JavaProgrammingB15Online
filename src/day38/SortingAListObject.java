...
public class SortingAListObject {
    ...
    public static void main(String[] args) {
        ...
        it has a lot of ready method to work with Collection Objects like ArrayList asn so on
        */
        ...
        good news is there is ready method aready in Java
        we can get reverse order comparator object by calling
        Comparator.reverseOrder() , just take it and use it
         */

        Collections.sort(nums, Comparator.reverseOrder());
        System.out.println("nums after using Comparator.reverseOrder() = " + nums);
