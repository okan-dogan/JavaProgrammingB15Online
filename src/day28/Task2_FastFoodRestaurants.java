...
public class Task2_FastFoodRestaurants {
        ...
        public static void main(String[] args) {
            ...
            for (int i = 0; i <restaurants.length ; i++) {
                ...
                if(restaurants[i].contains("mcdonalds")){
                    mcdonalsCount++;
                }else if(restaurants[i].contains("popeyes")){
                    popeyesCount++;
                }else if(restaurants[i].contains("dominos")){
                    dominosCount++;
                }else if(restaurants[i].contains("tacobell")){
                    tacoBellCount++;
                }
            }
            ...
            for (int i = 0; i <restaurants.length ; i++) {
                if(restaurants[i].contains("mcdonalds")&&restaurants[i].contains("TX")){
                    System.out.println((counter)+". "+restaurants[i]);
                    counter++;
                }
            }
            ...
            String [] firstRestaurant = restaurants[0].split(",");
            System.out.println(Arrays.toString(firstRestaurant));
            System.out.println(firstRestaurant[2]+" -> "+firstRestaurant[1]+", "+firstRestaurant[4]);

            System.out.println("=================================");

            for (int i = 0; i <restaurants.length ; i++) {
                String [] tempRestaurant = restaurants[i].split(",");
                System.out.println(tempRestaurant[2]+" -> "+tempRestaurant[1]+", "+tempRestaurant[4]);
            }
