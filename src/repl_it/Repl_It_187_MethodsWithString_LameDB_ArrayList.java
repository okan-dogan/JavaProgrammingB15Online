...
public class Repl_It_187_MethodsWithString_LameDB_ArrayList {
    ...
    public static String lameDb(String db, String op,String id,String data){
        List<String> parts = new ArrayList<>(Arrays.asList(db.split("#"))) ;
        Integer idInt = Integer.valueOf(id);
        String result="";
        switch (op){
            case "add":
                parts.add(idInt-1,id+data);
                break;
            case "edit":
                parts.set(idInt-1,id+data);
                break;
            case "delete":
                parts.remove(idInt-1);
                break;
        }
