...
The machine already gets the money and can categorize it onto type and amount. it also have the current conversion rates.
...
check USD conversion rate for that currency in the second array
then multiple them to get how much USD he will end up with total.

for example:
convertC([["drachma","11.0"],["sek","5.0"]]   ,   [["drachma","0.6"],["sek","100"]]);
returns:  506.6
(Bob has 11.0  drachma and 5.0 Sek currency money and
he needs to convert them to USD.
Conversion rates are in second array.
So we multiple (11.0 * 0.6) +(5.0 * 100) and return the result    )
...
public class Repl_It_212_2DArrays_CurrencyConversion {
    ...
    public static void main(String[] args) {
        ...
        double res = Repl_It_212_2DArrays_CurrencyConversion.convertC(test_money,test_convert);
