...
public class Repl_It_141_ArrayMakeLast {
    ...
    public static void main(String[] args) {
        ...
        int[] doubledSize=new int[size*2];
        doubledSize[doubledSize.length-1]=nums[size-1];
        System.out.println(Arrays.toString(doubledSize));
